				...
				<td>
					<?php 
						echo $this->Form->postLink(
							...
							array(
								'controller' => 'words',
								'action' => 'edit_words', $word['Word']['id']
							)
						); 
					?>
				</td>
				<td>
					<?php 
						echo $this->Form->postLink(
							...
							array(
								'controller' => 'words',
								'action' => 'delete_words', $word['Word']['id']
							), 
							null, 
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('New Words'), array('controller' => 'words', 'action' => 'add_words')); ?></li>
	</ul>
	<ul>
